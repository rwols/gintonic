...
BOOST_AUTO_TEST_CASE(operators_test)
{
    ...
    // around
    // [0,0,-1]. This is the same as rotating CW 90 degrees around [0,0,1],
    // which
...
BOOST_AUTO_TEST_CASE(particular_vertex)
{
    auto a = quatf::axis_angle(vec3f(0.0f, 1.0f, 0.0f), deg2rad(-89.113f));
}
