...
public:
	...
	private:
		...
		Joint(const FBXSDK_NAMESPACE::FbxNode* pFbxNode, const uint8_t parentIndex);
	...
	public:
		...
		inline const FBXSDK_NAMESPACE::FbxNode* getFbxNode() const noexcept { return mNode; }
	protected:
	...
	public:
		...
		inline const char* what() const noexcept { return "TooManyChildJointsException"; }
	private:
		friend class Skeleton;
		TooManyChildJointsException(const FBXSDK_NAMESPACE::FbxNode* pNode) : Exception(pNode) {}
	};
	...
	public:
		...
		inline const char* what() const noexcept { return "TooManyJointsException"; }
	private:
		friend class Skeleton;
		TooManyJointsException(const FBXSDK_NAMESPACE::FbxNode* pNode) : Exception(pNode) {}
	};
...
private:
	...
	void constructJointsRecursive(const FBXSDK_NAMESPACE::FbxNode*, const uint8_t);
};
