...
public:
	 ...
	 */
	BufferObject(const GLenum target, const GLsizei size, 
	 ...
	 * @param other Another BufferObject.
	 */
	inline BufferObject(BufferObject&& other) noexcept 
	 ...
	 * @param other Another BufferObject.
	 */
	inline void swap(BufferObject& other)
	{
