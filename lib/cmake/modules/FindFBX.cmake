...
if (WIN32) # FIXME!
    ...
    if(BUILD_STATIC_LIBS OR NOT BUILD_SHARED_LIBS)
        if(NOT DEFINED CMAKE_BUILD_TYPE OR CMAKE_BUILD_TYPE STREQUAL Debug)
            # Assume multithreaded static debug version
            set(fbx_libname ${fbx_libname}-md)
        else()
            # Assume multithreaded static release version
            set(fbx_libname ${fbx_libname}-mt)
        endif()
    else()
        add_definitions(/DFBX_SHARED)
    endif()
elseif (APPLE)
