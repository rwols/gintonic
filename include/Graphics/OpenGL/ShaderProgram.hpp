...
protected:
	...
	{
		glUniform3f(getUniformLocation(name), values[0], values[1], 
			values[2]);
	}
	...
	{
		glUniform4f(getUniformLocation(name), values[0], values[1], 
			values[2], values[3]);
	}
	...
	{
		glUniform3i(getUniformLocation(name), values[0], values[1], 
			values[2]);
	}
	...
	{
		glUniform4i(getUniformLocation(name), values[0], values[1], 
			values[2], values[3]);
	}
	...
	{
		glUniform3ui(getUniformLocation(name), values[0], values[1], 
			values[2]);
	}
	...
	{
		glUniform4ui(getUniformLocation(name), values[0], values[1], 
			values[2], values[3]);
	}
	 ...
	 */
	static void setUniform(const GLint location, const GLfloat value) 
		noexcept;
	 ...
	 * @param value The value for the uniform.
	 */
	static void setUniform(const GLint location, const vec2f& value) 
		noexcept;
	 ...
	 * @param value The value for the uniform.
	 */
	static void setUniform(const GLint location, const vec3f& value) 
		noexcept;
	 ...
	 * @param value The value for the uniform.
	 */
	static void setUniform(const GLint location, const vec4f& value) 
		noexcept;
	 ...
	 * @param value The value for the uniform.
	 */
	static void setUniform(const GLint location, const mat3f& value) 
		noexcept;
	 ...
	 * @param value The value for the uniform.
	 */
	static void setUniform(const GLint location, const mat4f& value) 
		noexcept;
	 ...
	 * @param value The value for the uniform.
	 */
	static void setUniform(const GLint location, const GLint value) 
		noexcept;
