 ...
 */
class GINTONIC_EXPORT Framebuffer
{
  private:
    GLuint mHandle;
  ...
  public:
    ...
    class Exception : public std::exception
    {
      ...
      private:
        static const char*
        statusCodeToErrorString(const GLenum status) noexcept;
    };
    ...
    /// Destructor.
    inline ~Framebuffer() { glDeleteFramebuffers(1, &mHandle); }
    ...
    /// Move constructor.
    inline Framebuffer(Framebuffer&& other) : mHandle(other.mHandle)
    {
        other.mHandle = 0;
    }
