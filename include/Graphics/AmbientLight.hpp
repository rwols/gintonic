 ...
 * scene.
 */
class GINTONIC_EXPORT AmbientLight : public Light
{
  public:
    using Super = Light;
    ...
    {
        return SharedPtr(new AmbientLight(std::forward<Args>(args)...));
    }
  ...
  public:
     ...
     * case of an AmbientLight.
     */
    inline virtual float getCosineHalfAngle() const noexcept { return 0.0f; }
