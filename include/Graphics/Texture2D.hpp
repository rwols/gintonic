 ...
 */
class GINTONIC_EXPORT Texture2D
      ...
      public Asset
{
  ...
  public:
     ...
     */
    class GINTONIC_EXPORT NoImageDataException : public std::exception
    {
      public:
     ...
     * @brief Can be thrown during construction of a Texture2D.
     */
    class GINTONIC_EXPORT UnknownImageFormatException : public std::exception
    {
      public:
        ...
        const char* what() const noexcept override
        {
            return "UnknownImageFormatException";
        }
    };
    ...
    struct GINTONIC_EXPORT ImageLoadOptions
    {
