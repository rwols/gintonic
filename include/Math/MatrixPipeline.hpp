 ...
 */
class GINTONIC_EXPORT MatrixPipeline
{
  public:
    /**
    ...
    {
        mProjectionMatrix =
            mat4f(std::forward<MatrixConstructorArguments>(args)...);
        mProjectionViewModelMatrixIsDirty = true;
        mProjectionViewMatrixIsDirty = true;
    }
    ...
    void setProjectionViewModelMatrices(Arg0&& projectionMatrix,
                                        Arg1&& viewMatrix, Arg2&& modelMatrix)
    {
     ...
     */
    inline const mat4f& getViewMatrix() const noexcept { return mViewMatrix; }

    /**
     * @brief Get the model matrix.
     * @return The model matrix.
     */
    inline const mat4f& getModelMatrix() const noexcept { return mModelMatrix; }
    ...
    inline const mat4f& getProjectionViewModelMatrix() const noexcept
    {
        ...
        {
            mProjectionViewModelMatrix =
                mProjectionMatrix * getViewModelMatrix();
    ...
    inline const mat3f& getNormalMatrix() const noexcept
    {
        ...
        {
            mNormalMatrix =
                getViewModelMatrix().upperLeft33().invert().transpose();
