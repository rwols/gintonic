 ...
 */
struct GINTONIC_EXPORT alignas(__m128) SQT
{
    /**
     ...
     */
    inline SQT()
        : scale(1.0f, 1.0f, 1.0f), rotation(1.0f, 0.0f, 0.0f, 0.0f),
     ...
     */
    inline SQT(const vec3f& scale, const quatf& rotation,
     ...
     * is taken. Observe then, if `sqt` is an SQT, then `sqt.inverse() % sqt ==
     * SQT();`
     * @return The inverse.
     */
    ...
    inline void look_at(const SQT& other) noexcept
    {
        ...
        rotation = quatf::look_at(translation, other.translation,
  ...
  private:
    ...
    void serialize(Archive& ar, const unsigned /*version*/)
    {
        ...
        ar& BOOST_SERIALIZATION_NVP(scale) & BOOST_SERIALIZATION_NVP(rotation) &
