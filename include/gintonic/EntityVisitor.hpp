...
class EntityVisitor
{
  ...
  protected:
     ...
     */
    inline std::size_t currentDepth() const noexcept { return mDepth; }
  ...
  private:
     ...
     * should be aborted.
     */
    virtual bool onVisit(Entity& entity) = 0;
     ...
     * if EntityVisitor::onStart returns false, and even if
     * EntityVisitor::onVisit
