...
#define GT_DEFINE_UNIFORM(UNIFORM_TYPE, UNIFORM_NAME,                          \
                          UNIFORM_NAME_WITH_FIRST_CAPITAL)                     \
    ...
    {                                                                          \
      ...
      public:                                                                  \
        /**                                                                    \
         * @brief Set the value of the UNIFORM_NAME uniform in the shader      \
         * program.                                                            \
...
GT_DEFINE_UNIFORM(GLint, geometryBufferPositionTexture,
                  GeometryBufferPositionTexture);
GT_DEFINE_UNIFORM(GLint, geometryBufferDiffuseTexture,
                  GeometryBufferDiffuseTexture);
GT_DEFINE_UNIFORM(GLint, geometryBufferSpecularTexture,
                  GeometryBufferSpecularTexture);
GT_DEFINE_UNIFORM(GLint, geometryBufferNormalTexture,
                  GeometryBufferNormalTexture);
...
#define GT_DEFINE_UNIFORM_BLOCK(UNIFORM_NAME, UNIFORM_NAME_WITH_FIRST_CAPITAL) \
    ...
    {                                                                          \
      ...
      public:                                                                  \
         ...
         */                                                                    \
        inline GLuint                                                          \
            GT_PASTE_TOGETHER(get, UNIFORM_NAME_WITH_FIRST_CAPITAL)() const    \
            noexcept                                                           \
        {                                                                      \
            return mIndex;                                                     \
        }                                                                      \
        inline void bindBuffer(const OpenGL::BufferObject& buffer) const       \
            noexcept                                                           \
        {                                                                      \
 ...
 */
template <class DerivedShaderProgram> class ShaderProgramBase
{
  public:
    /**
 ...
 */
class MaterialShaderProgram : public ShaderProgramBase<MaterialShaderProgram>,
...
class ShadowShaderProgram : public ShaderProgramBase<ShadowShaderProgram>,
                            public Uniform::matrixPVM,
                            public Uniform::instancedRendering
{
  public:
 ...
 */
class SpotLightShaderProgram : public ShaderProgramBase<SpotLightShaderProgram>,
                               public Uniform::matrixPVM,
                               public Uniform::viewportSize,
                               public Uniform::geometryBufferPositionTexture,
                               public Uniform::geometryBufferDiffuseTexture,
 ...
 */
class SkyboxShaderProgram : public ShaderProgramBase<SkyboxShaderProgram>,
 ...
 */
class FlatTextShaderProgram : public ShaderProgramBase<FlatTextShaderProgram>,
...
class GUIShaderProgram : public ShaderProgramBase<GUIShaderProgram>,
