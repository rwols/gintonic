...
{
    GINTONIC_ASSET_BOILERPLATE(Material, "materials", ".mat");
    GINTONIC_ASSET_BOILERPLATE_TRIVIAL_CONSTRUCTORS(Material);
  ...
  public:
    ...
    /**
     * @brief Converts an FBX surface material into our own material.
    ...
    fromFbxMaterial(const FBXSDK_NAMESPACE::FbxSurfaceMaterial* fbxmat);
  ...
  private:
    ...
    void serialize(Archive& archive, const unsigned int /*version*/)
    {
        archive& BOOST_SERIALIZATION_BASE_OBJECT_NVP(Asset) &
            mFloats& mVec2s& mVec3s& mVec4s& mMat4s& mTextures;
    }
};
