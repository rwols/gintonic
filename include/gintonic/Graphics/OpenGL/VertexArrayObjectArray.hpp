 ...
 * [OpenGL Vertex Array
 * Object](https://www.opengl.org/wiki/Vertex_Specification#Vertex_Array_Object)s.
 *
...
template <GLuint Size> class VertexArrayObjectArray
{
  public:
    /// Default constructor.
    inline VertexArrayObjectArray() { glGenVertexArrays(Size, m_handles); }
    ...
    /// You cannot copy vertex array object arrays.
    VertexArrayObjectArray& operator=(const VertexArrayObjectArray&) = delete;
     ...
     */
    inline GLuint operator[](const GLuint index) const noexcept
    {
...
template <class GLuint Size>
VertexArrayObjectArray<Size>& VertexArrayObjectArray<Size>::
operator=(VertexArrayObjectArray<Size>&& other)
{
