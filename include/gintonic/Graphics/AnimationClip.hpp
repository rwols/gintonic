  ...
  public:
    class BakeLayersException : public std::exception
    {
      public:
        ...
        inline FBXSDK_NAMESPACE::FbxAnimStack* getFbxAnimStack() const noexcept
        {
            return mStack;
        }
      ...
      private:
        ...
        BakeLayersException(FBXSDK_NAMESPACE::FbxAnimStack* pStack)
            : mStack(pStack)
        {
        }
    ...
    AnimationClip(FBXSDK_NAMESPACE::FbxAnimStack* pStack,
