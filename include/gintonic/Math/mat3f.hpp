...
union alignas(__m128) mat3f {
  public:
    ...
    mat3f(const float diagonal)
        : m00(diagonal), m10(0.0f), m20(0.0f), m01(0.0f), m11(diagonal),
          m21(0.0f), m02(0.0f), m12(0.0f), m22(diagonal)
    {
        GT_PROFILE_FUNCTION;
    }
    ...
    mat3f(const float scalex, const float scaley, const float scalez)
        : m00(scalex), m10(0.0f), m20(0.0f), m01(0.0f), m11(scaley), m21(0.0f),
    ...
    mat3f(const float m00, const float m01, const float m02, const float m10,
          const float m11, const float m12, const float m20, const float m21,
          const float m22)
        : m00(m00), m10(m10), m20(m20), m01(m01), m11(m11), m21(m21), m02(m02),
          m12(m12), m22(m22)
    {
        GT_PROFILE_FUNCTION;
    }
...
BOOST_CLASS_IMPLEMENTATION(NAMESPACE_GINTONIC::mat3f,
